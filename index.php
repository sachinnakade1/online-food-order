    ...
    <header id="header" class="header-scroll top-header headrom">
        ...
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" <a href="#"> <img src="images/fooddu.jpeg" style="height: 100px;border-radius:5px" alt="Footer logo"> </a>
    ...
    <section class="hero bg-image" data-image-src="images/img/main.jpeg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                ...
                <h5 class="font-white space-xs">Good Food for Good Moments.</h5>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <p>We"ve got your covered with menus from best Restaurants and Hotels.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row top-footer">
                <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                    <a href="#"> <img src="images/fooddu.jpeg" style="height: 100px;border-radius:5px" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span>
                </div>
                ...
                <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                    ...
                    <ul>
                        <li><a href="#">GandhinNagar</a> </li>
                        <li><a href="#">Bustop</a> </li>
                        <li><a href="#">Jalaram square</a> </li>
                        <li><a href="#">Library square</a> </li>
                        <li><a href="#">Rajiv gandhi square</a> </li>
                        <li><a href="#"> Shastri square</a> </li>
                        <li><a href="#">Khat Road</a> </li>
                      <!--  <li><a href="#"></a> </li>
            ...
            <div class="bottom-footer">
                <div class="row">
                    <div class="col-xs-12 col-sm-3 payment-options color-gray">
                        ...
                        <ul>
                            <li>
                               <a href="#"> <img src="images/phonepay.png" style="height: 50px;border-radius:5px" alt="phonepay"> </a>
                            </li>
                            <li>
                                <a href="#"> <img src="images/amazon-pay.jpg"style="height: 35px;border-radius:5px" alt="amezonepay"> </a>
                            </li>
                            <li>
                    ...
                    <div class="col-xs-12 col-sm-4 address color-gray">
                        ...
                        <h5>Phone: <a href="tel:+080000012222">9699505994</a></h5>
                    </div>
